export const swProjects = [
  { name: 'SW Builders', source: './projects/index.js' },
  { name: 'SW Builders (Profiles)', source: './projects/profile-examples.js' },
  { name: 'SW Builders (Arches)', source: './projects/arch-examples.js' },
