...
const main = () => {
    ...
    const mould1 = moulds.cuboidMouldingOneEdge({ size: [20, 40, 8], geomProfile: circNotchprofile });
    ...
    const mould2 = moulds.cuboidMoulding({ size: [10, 40, 8], geomProfile: circNotchprofile });
    ...
    const mould3 = moulds.circularMoulding({ radius: 20, height: 8, geomProfile: circProtProfile });
    ...
    const mould4 = moulds.circularMoulding({ segments: 8, radius: 20, height: 8, geomProfile: circProtProfile });
